...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const adminbotnumber = ["6289509938750@s.whatsapp.net"]
			const frendsowner = ["6289509938750@s.whatsapp.net"]
			...
			case 'style':
                 ...
                 client.sendMessage(from, 'Itu bro owner aku kak, Kalau ada perlu chat dia aje, Ajakin baku hantam wkwk!!',MessageType.text, { quoted: mek} )
                 break
                 case 'fitnah':	
				case 'fake':          
				...
				case 'fb':
               if (!isGroup) return reply(mess.only.group)
               data = await fetchJson(`https://mhankbarbar.tech/api/epbe?url=${body.slice(4)}&apiKey=Nkwp9oR7Eg9yykbejBpm`)
               ...
               break
				...
				case 'galaxtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=H527Y93838H2OUQR27`)
		   ...
		   case 'marvelogo':
				...
				case 'tag':
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=${gbl1}&pasangan=${gbl2}&apikey=H527Y93838H2OUQR27`)
				...
				case 'loli':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					...
					if (teks.length > 9) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					buffer = await getBuffer(`https://mhankbarbar.tech/api/emoji2png?emoji=${teks}`)
				...
				case 'cekjodoh':                    
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=H527Y93838H2OUQR27`)
				...
				case 'thunder':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=H527Y93838H2OUQR27`)
                ...
                case 'stiltext':
                      ...
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
                      buff = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=H527Y93838H2OUQR27`)
                      reply(mess.wait)
                ...
                case 'testing':
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/silktext?text=${coli1}&text2=${coli2}&apikey=H527Y93838H2OUQR27`)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'testing2':
					var gh = body.slice(9)
					...
					if (args.length < 1) return reply('Teks nya mana?')
					reply(mess.wait)
					party = await getBuffer(`https://api.vhtear.com/partytext?text=${coli1}&text2=${coli2}&apikey=H527Y93838H2OUQR27`)
				...
				case 'party':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=H527Y93838H2OUQR27`)
				...
				case 'rtext':
					...
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=H527Y93838H2OUQR27`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: teks})
					break
				case 'water':
					if (args.length < 1) return reply(mess.blank)
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'tagme':
					...
					const tag = {
					text: `@${nom.split("@s.whatsapp.net")[0]} hay sayangku😘`,
                ...
                case 'ttp':
					...
					anu = await fetchJson(`https://mhankbarbar.tech/api/text2image?text=${ttp}&apiKey=Nkwp9oR7Eg9yykbejBpm`, {method: 'get'})
                ...
                case 'report':
                    ...
                    client.sendMessage('6289509938750@s.whatsapp.net', options, text, {quoted: mek})
				...
				case 'walpaperhd':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teks}&apikey=H527Y93838H2OUQR27`)
				...
				case 'wibu':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=H527Y93838H2OUQR27`)
					if (anu.error) return reply(anu.error)
				...
				case 'randomcat':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomcat?apikey=H527Y93838H2OUQR27`)
					if (anu.error) return reply(anu.error)
				...
				case 'mlherolist':
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=H527Y93838H2OUQR27`)
				...
				case 'ramalhp':
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=H527Y93838H2OUQR27`)
					reply(anu.result.hasil)
					break
				case 'textscreen':
					if (args.length < 1) return reply('teks nya mana om')
					tels = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${tels}&apikey=H527Y93838H2OUQR27`, {method: 'get'})
               ...
               case 'infogempa':
                ...
                case 'infocuaca':
                   ...
                   break
                case 'tebakgambar':
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					...
					break
                case 'caklontong':
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					setTimeout( () => {
					...
					break
				case 'family100':
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                case 'brainly':
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					reply(anu.result.data)
					break
                case 'image':
					if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					reply(mess.wait)
                ...
                case 'pokemon':
					...
					break
				case 'inu':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=inu&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					...
					break
				case 'elang':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'naruto':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'minato':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'boruto':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'hinata':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'sasuke':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'sakura':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'kaneki':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'toukachan':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'rize':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'akira':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'itori':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'kurumi':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumi&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'miku':
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					...
					break
                                case 'unta':
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=H527Y93838H2OUQR27`, {method: 'get'})
				...
				case 'hentai':
					if (!isNsfw) return reply('❌ *FALSE* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=H527Y93838H2OUQR27`, {method: 'get'})
                ...
                case 'pinterest':
					...
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=H527Y93838H2OUQR27`, {method: 'get'})
					reply(mess.wait)
				...
				case 'tulis':
					...
					tulis = body.slice(6)
					reply(mess.wait)
					buffer = await getBuffer(`https://api.vhtear.com/write?text=${tulis}&apikey=H527Y93838H2OUQR27`)
			    ...
			    case 'lovemake':
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buff = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=H527Y93838H2OUQR27`, {method: 'get'})
                    client.sendMessage(from, buff, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
				...
				case 'infomotor':
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=H527Y93838H2OUQR27`)
					buffer = await getBuffer(anu.result.image)
				...
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=H527Y93838H2OUQR27`)
				...
				case 'url2img':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://mhankbarbars.tech/api/url2image?tipe=${args[0]}&url=${args[1]}&apiKey=Nkwp9oR7Eg9yykbejBpm`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
